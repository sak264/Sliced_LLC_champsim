...
bin/champsim: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno_instr.a obj/pref_pprefetcherDno.a obj/bpred_bbranchDbimodal.a obj/btb_bbtbDbasic_btb.a
